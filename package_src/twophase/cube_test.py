...
train_X, train_Y = generate_data(500000)  # 8000 training samples
test_X, test_Y = generate_data(50000)     # 2000 test samples
...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential(
            ...
            nn.ReLU(),          # Activation function
            nn.Linear(64, 1)    # Output layer with 1 output (n)
        )
...
# Training loop
num_epochs = 1000  # Adjust this as needed
prev_loss = 0
count = 0
